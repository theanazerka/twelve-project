...
- (void)storeConversationList:(NSArray *)conversations replace:(bool)replace folderId:(int32_t)folderId;
- (void)setConversationArchived:(int64_t)conversationId archived:(bool)archived;
...
- (void)loadConversationListFromDate:(int)date limit:(int)limit excludeConversationIds:(NSArray *)excludeConversationIds folderId:(int32_t)folderId completion:(void (^)(NSArray *result, bool loadedAllRegular))completion;
...
- (NSArray *)_syncCachedRecentInlineBots:(CGFloat)rating;
- (void)replaceCachedRecentPeers:(TGRemoteRecentPeerCategories *)categories;
- (void)updatePeerRatings:(NSArray *)updates;
- (NSArray *)peerRatingUpdatesFromOutgoingMessageEvents:(NSDictionary *)outgoingMessageEvents;
- (void)resetPeerRating:(int64_t)peerId category:(TGPeerRatingCategory)category;

- (void)transactionAddMessages:(NSArray *)addMessages updateConversationDatas:(NSDictionary *)updateConversationDatas notifyAdded:(bool)notifyAdded;
- (void)transactionRemoveMessages:(NSDictionary *)removeMessages updateConversationDatas:(NSDictionary *)updateConversationDatas;
- (void)transactionUpdateMessages:(NSArray *)updateMessages updateConversationDatas:(NSDictionary *)updateConversationDatas;
- (void)transactionRemoveMessagesInteractive:(NSDictionary *)removeMessagesInteractive keepDates:(bool)keepDates removeMessagesInteractiveForEveryone:(bool) removeMessagesInteractiveForEveryone updateConversationDatas:(NSDictionary *)updateConversationDatas;
- (void)transactionResetPeerReadStates:(NSDictionary *)resetPeerReadStates;
- (void)transactionResetPeerUnseenMentionsStates:(NSDictionary *)resetPeerUnseenMentionsStates;
- (void)transactionReadHistoryForPeerIds:(NSArray *)peerIds;
- (void)transactionApplyMaxOutgoingReadIds:(NSDictionary *)applyMaxOutgoingReadIds;
- (void)transactionClearConversationsWithPeerIds:(NSArray *)peerIds interactive:(bool)interactive;
- (void)transactionRemoveConversationsWithPeerIds:(NSArray *)peerIds;
- (void)transactionUpdatePinnedConversations:(NSArray *)pinnedConversations synchronizePinnedConversations:(bool)synchronizePinnedConversations forceReplacePinnedConversations:(bool)forceReplacePinnedConversations;
- (void)transactionReadMessageContentsInteractive:(NSDictionary *)readMessageContentsInteractive;
- (void)transactionUpdateFeededChannels:(NSDictionary *)feededChannels newlyJoinedFeedId:(int32_t)newlyJoinedFeedId synchronizeFeededChannels:(bool)synchronizeFeededChannels;
- (void)transactionCalculateUnreadChats;

// Flushes lightweight conversation/message notifications that were deferred
// while an iOS 6 application was in the background. Database state itself is
// always committed immediately.
- (void)ios6FlushDeferredBackgroundUpdates;

- (void)transactionAddMessages:(NSArray *)addMessages
           notifyAddedMessages:(bool)notifyAddedMessages
                removeMessages:(NSDictionary *)removeMessages
                updateMessages:(NSArray *)updateMessages
              updatePeerDrafts:(NSDictionary *)updatePeerDrafts
     removeMessagesInteractive:(NSDictionary *)removeMessagesInteractive
                     keepDates:(bool)keepDates
removeMessagesInteractiveForEveryone:(bool)removeMessagesInteractiveForEveryone
       updateConversationDatas:(NSDictionary *)updateConversationDatas
       applyMaxIncomingReadIds:(NSDictionary *)applyMaxIncomingReadIds
       applyMaxOutgoingReadIds:(NSDictionary *)applyMaxOutgoingReadIds
     applyMaxOutgoingReadDates:(NSDictionary *)applyMaxOutgoingReadDates
              applyUnreadMarks:(NSDictionary *)applyUnreadMarks
         readHistoryForPeerIds:(NSArray *)readHistoryForPeerIds
           resetPeerReadStates:(NSDictionary *)resetPeerReadStates
 resetPeerUnseenMentionsStates:(NSDictionary *)resetPeerUnseenMentionsStates
 clearConversationsWithPeerIds:(NSArray *)clearConversationsWithPeerIds
 clearConversationsInteractive:(bool)clearConversationsInteractive
removeConversationsWithPeerIds:(NSArray *)removeConversationsWithPeerIds
     updatePinnedConversations:(NSArray *)updatePinnedConversations
...
readMessageContentsInteractive:(NSDictionary *)readMessageContentsInteractive
          deleteEarlierHistory:(NSDictionary *)deleteEarlierHistory
          updateFeededChannels:(NSDictionary *)updateFeededChannels
...
- (void)_addedNewMessages:(NSArray *)messages;
...
- (void)updateWebpages:(NSArray *)webpages;

- (void)cacheBotCallbackResponse:(NSData *)key response:(NSData *)response;
- (NSData *)_cachedBotCallbackResponse:(NSData *)data;

- (NSArray *)contactUsersMatchingPhone:(NSString *)phoneNumber;

- (NSArray *)_getPinnedConversations;
...
- (void)_addUnreadMensionMessageIds:(int64_t)peerId messageIds:(NSArray *)messageIds replaceAfter:(int32_t)replaceAfter afterFinal:(bool)afterFinal;
...
- (NSArray *)loadLiveLocationSessions;
