#ifndef TG_LEGACY_TL_TLUPDATE_H
#define TG_LEGACY_TL_TLUPDATE_H
...
@interface TLUpdate$updatePhoneCallSignalingData : TLUpdate
...
@interface TLCodexFolderPeer : NSObject <TLObject>
...
@interface TLUpdate$updateFolderPeers : TLUpdate

@property (nonatomic, retain) NSArray *folder_peers;
@property (nonatomic) int32_t pts;
@property (nonatomic) int32_t pts_count;

@end

@interface TLUpdate$updateMessageReactionsCodex : TLUpdate

@property (nonatomic, retain) TLPeer *peer;
@property (nonatomic) int32_t msg_id;
@property (nonatomic, retain) NSString *reactionSummary;
@property (nonatomic, retain) NSString *chosenReaction;
