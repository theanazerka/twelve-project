...
@implementation TLRPCphone_sendSignalingData
...
@implementation TLRPCphone_sendSignalingData$phone_sendSignalingData : TLRPCphone_sendSignalingData


- (int32_t)TLconstructorSignature
{
    return (int32_t)0xff7a9383;
}

- (int32_t)TLconstructorName
{
    return (int32_t)0x19468a40;
}

- (id<TLObject>)TLbuildFromMetaObject:(std::shared_ptr<TLMetaObject>)metaObject
{
    TLRPCphone_sendSignalingData$phone_sendSignalingData *object = [[TLRPCphone_sendSignalingData$phone_sendSignalingData alloc] init];
