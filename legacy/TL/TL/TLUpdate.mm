...
@implementation TLUpdate$updatePhoneCallSignalingData : TLUpdate


- (int32_t)TLconstructorSignature
{
    return (int32_t)0x2661bf09;
}

- (int32_t)TLconstructorName
{
    return (int32_t)0xe7032ab6;
}

- (id<TLObject>)TLbuildFromMetaObject:(std::shared_ptr<TLMetaObject>)metaObject
{
    TLUpdate$updatePhoneCallSignalingData *object = [[TLUpdate$updatePhoneCallSignalingData alloc] init];
    int64_t phoneCallId = metaObject->getInt64((int32_t)0xc0ea171e);
    if (phoneCallId == 0)
        phoneCallId = metaObject->getInt64((int32_t)0x7a5601fb);
    if (phoneCallId == 0)
        phoneCallId = metaObject->getInt64((int32_t)0x50a89b2c);
    object.phone_call_id = phoneCallId;
    object.data = metaObject->getBytes((int32_t)0xa361765d);
    TGLog(@"IOS6CALL signaling.update.parse call=%lld dataLen=%d", object.phone_call_id, (int)object.data.length);
    return object;
}
...
{
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypePrimitiveInt64;
        value.primitive.int64Value = self.phone_call_id;
        values->insert(std::pair<int32_t, TLConstructedValue>((int32_t)0xc0ea171e, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypeBytes;
...
@implementation TLCodexFolderPeer

- (int32_t)TLconstructorSignature
{
    return (int32_t)0xe9baa668;
}
...
@implementation TLUpdate$updateFolderPeers

- (int32_t)TLconstructorSignature
{
    return (int32_t)0x19360dc0;
}
...
@implementation TLUpdate$updateMessageReactionsCodex

- (int32_t)TLconstructorSignature
{
    return (int32_t)0x1e297bfa;
}
