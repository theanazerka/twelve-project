...
void TLRegisterClasses()
{
    ...
    TLMetaClassStore::registerObjectClass([TLUpdate$updatePhoneCallSignalingData new]);
    ...
    TLMetaClassStore::registerObjectClass([TLRPCphone_sendSignalingData$phone_sendSignalingData new]);
