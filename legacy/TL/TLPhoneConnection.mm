...
- (id<TLObject>)TLbuildFromMetaObject:(std::shared_ptr<TLMetaObject>)metaObject
{
    ...
    TGLog(@"IOS6CALL parse phoneConnection flags=%d id=%lld ip=%@ ipv6=%@ port=%d peerTagLen=%d", object.flags, object.n_id, object.ip, object.ipv6, object.port, (int)object.peer_tag.length);
    return object;
}
...
@implementation TLPhoneConnection$phoneConnectionWebrtc : TLPhoneConnection


- (int32_t)TLconstructorSignature
{
    return (int32_t)0x635fe375;
}
...
- (id<TLObject>)TLbuildFromMetaObject:(std::shared_ptr<TLMetaObject>)metaObject
{
    TLPhoneConnection$phoneConnectionWebrtc *object = [[TLPhoneConnection$phoneConnectionWebrtc alloc] init];
    object.flags = metaObject->getInt32((int32_t)0x81915c23);
    object.n_id = metaObject->getInt64((int32_t)0x7a5601fb);
    object.ip = metaObject->getString((int32_t)0xe5956ecc);
    object.ipv6 = metaObject->getString((int32_t)0x555f25db);
    object.port = metaObject->getInt32((int32_t)0x81ce65c9);
    object.username = metaObject->getString((int32_t)0xd814e8b);
    object.password = metaObject->getString((int32_t)0x8e49a0e8);
    TGLog(@"IOS6CALL parse phoneConnectionWebrtc flags=%d id=%lld ip=%@ ipv6=%@ port=%d user=%@ passLen=%d", object.flags, object.n_id, object.ip, object.ipv6, object.port, object.username, (int)object.password.length);
    return object;
}
...
- (void)TLfillFieldsWithValues:(std::map<int32_t, TLConstructedValue> *)values
{
    ...
    }
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>((int32_t)0xd814e8b, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypeString;
        value.nativeObject = self.password;
        values->insert(std::pair<int32_t, TLConstructedValue>((int32_t)0x8e49a0e8, value));
    }
}
