    ...
    return [[SSignal alloc] initWithGenerator:^id<SDisposable>(SSubscriber *subscriber)
    {
        ...
        [avAsset loadValuesAsynchronouslyForKeys:requiredKeys completionHandler:^
        {
            [queue dispatch:^
            {
                ...
                CGSize dimensions = ((AVAssetTrack *)[[avAsset tracksWithMediaType:AVMediaTypeVideo] objectAtIndex:0]).naturalSize;
                ...
                [self processWithConversionContext:context completionBlock:^
                {
                    ...
                    [resultContext.imageGenerator generateCGImagesAsynchronouslyForTimes:@[ [NSValue valueWithCMTime:kCMTimeZero] ] completionHandler:^(__unused CMTime requestedTime, CGImageRef   image, __unused CMTime actualTime, AVAssetImageGeneratorResult result, __unused NSError *  error)
                    {
