...
#if __IPHONE_OS_VERSION_MAX_ALLOWED >= 80000
        if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 8.0 && [_locationManager respondsToSelector:@selector(requestWhenInUseAuthorization)]) {
