...
- (void)loadView
{
    ...
    if ([_mapView respondsToSelector:NSSelectorFromString(@"setRotateEnabled:")])
        [_mapView setValue:[NSNumber numberWithBool:false] forKey:@"rotateEnabled"];
...
{
    TGLocationCurrentLocationCell *cell = (TGLocationCurrentLocationCell *)[_tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:1 inSection:0]];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    else
    {
        ...
        TGLocationSectionHeaderCell *cell = (TGLocationSectionHeaderCell *)[_tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:_allowLiveLocationSharing ? 2 : 1  inSection:0]];
