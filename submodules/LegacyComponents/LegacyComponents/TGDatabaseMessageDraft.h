...
- (instancetype)initWithText:(NSString *)text entities:(NSArray *)entities disableLinkPreview:(bool)disableLinkPreview replyToMessageId:(int32_t)replyToMessageId date:(int32_t)date;
