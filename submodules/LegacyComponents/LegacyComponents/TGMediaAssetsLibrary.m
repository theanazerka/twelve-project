...
TGMediaLibraryAuthorizationStatus TGMediaLibraryCachedAuthorizationStatus = TGMediaLibraryAuthorizationStatusNotDetermined;
...
+ (bool)usesPhotoFramework
{
    ...
    // This target is built with the iOS 6 SDK. Its Photos declarations are
    // compatibility shims, so keep using ALAssetsLibrary on iOS 6-10.
    return false;
#else
    static dispatch_once_t onceToken;
