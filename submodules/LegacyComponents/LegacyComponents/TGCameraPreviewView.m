...
#define TG_AVSAMPLEBUFFERDISPLAYLAYER_IOS6_COMPAT 1
#define AVSampleBufferDisplayLayer CALayer
@interface CALayer (TGAVSampleBufferDisplayLayerCompatibility)
