...
- (id)init
{
    ...
    if (self)
    {
        ...
        TGActionMenuItem *clearChatListCacheItem = [[TGActionMenuItem alloc] initWithTitle:@"Clear chat list cache"];
        clearChatListCacheItem.action = @selector(clearChatListCacheButtonPressed);
        [miscSection.items addObject:clearChatListCacheItem];
...
- (void)clearChatListCacheButtonPressed
{
    TGLog(@"IOS6ARCHIVE settings clear chat list cache");
