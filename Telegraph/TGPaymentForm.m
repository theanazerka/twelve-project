...
- (instancetype)initWithIsTest:(bool)isTest nameRequested:(bool)nameRequested phoneRequested:(bool)phoneRequested emailRequested:(bool)emailRequested shippingAddressRequested:(bool)shippingAddressRequested flexible:(bool)flexible currency:(NSString *)currency prices:(NSArray *)prices {
    self = [super init];
    if (self != nil) {
        _isTest = isTest;
...
- (instancetype)initWithOptionId:(NSString *)optionId title:(NSString *)title prices:(NSArray *)prices {
    self = [super init];
    if (self != nil) {
        _optionId = optionId;
        _title = title;
...
- (instancetype)initWithInfoId:(NSString *)infoId shippingOptions:(NSArray *)shippingOptions {
    self = [super init];
    if (self != nil) {
        _infoId = infoId;
