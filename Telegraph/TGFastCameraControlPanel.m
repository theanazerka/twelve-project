...
#import "../submodules/LegacyComponents/LegacyComponents/TGCameraShutterButton.h"
#import "../submodules/LegacyComponents/LegacyComponents/TGCameraInterfaceAssets.h"
...
- (instancetype)init
{
    ...
    if (self != nil)
    {
        ...
        UIView *vibrantView = [[UIView alloc] initWithFrame:CGRectZero];
        ...
        [vibrantView addSubview:_cancelButton];
