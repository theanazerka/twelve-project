...
#import "../submodules/LegacyComponents/LegacyComponents/TGSecretTimerValueControllerItemView.h"
...
- (void)loadView
{
    ...
    if (_dateMode) {
        ...
        _datePicker.locale = [[NSLocale alloc] initWithLocaleIdentifier:effectiveLocalization().code];
