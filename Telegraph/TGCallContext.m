...
- (instancetype)initWithCallId:(int64_t)callId accessHash:(int64_t)accessHash date:(int32_t)date adminId:(int32_t)adminId participantId:(int32_t)participantId gA:(NSData *)gA keyFingerprint:(int64_t)keyFingerprint defaultConnection:(TGCallConnectionDescription *)defaultConnection alternativeConnections:(NSArray *)alternativeConnections {
    return [self initWithCallId:callId accessHash:accessHash date:date adminId:adminId participantId:participantId gA:gA keyFingerprint:keyFingerprint defaultConnection:defaultConnection alternativeConnections:alternativeConnections webrtcConnections:nil customParameters:nil];
}

- (instancetype)initWithCallId:(int64_t)callId accessHash:(int64_t)accessHash date:(int32_t)date adminId:(int32_t)adminId participantId:(int32_t)participantId gA:(NSData *)gA keyFingerprint:(int64_t)keyFingerprint defaultConnection:(TGCallConnectionDescription *)defaultConnection alternativeConnections:(NSArray *)alternativeConnections webrtcConnections:(NSArray *)webrtcConnections customParameters:(NSString *)customParameters {
    self = [super init];
    if (self != nil) {
        _callId = callId;
        _accessHash = accessHash;
...
- (instancetype)initWithCallId:(int64_t)callId accessHash:(int64_t)accessHash date:(int32_t)date adminId:(int32_t)adminId participantId:(int32_t)participantId key:(NSData *)key keyFingerprint:(int64_t)keyFingerprint defaultConnection:(TGCallConnectionDescription *)defaultConnection alternativeConnections:(NSArray *)alternativeConnections {
    return [self initWithCallId:callId accessHash:accessHash date:date adminId:adminId participantId:participantId key:key keyFingerprint:keyFingerprint defaultConnection:defaultConnection alternativeConnections:alternativeConnections webrtcConnections:nil customParameters:nil];
}

- (instancetype)initWithCallId:(int64_t)callId accessHash:(int64_t)accessHash date:(int32_t)date adminId:(int32_t)adminId participantId:(int32_t)participantId key:(NSData *)key keyFingerprint:(int64_t)keyFingerprint defaultConnection:(TGCallConnectionDescription *)defaultConnection alternativeConnections:(NSArray *)alternativeConnections webrtcConnections:(NSArray *)webrtcConnections customParameters:(NSString *)customParameters {
    self = [super init];
    if (self != nil) {
        _callId = callId;
        _accessHash = accessHash;
