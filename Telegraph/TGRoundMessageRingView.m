...
{
    CGFloat delta = fabsf(_immediateProgress - value);
...
- (void)drawRect:(CGRect)rect
{
    ...
    CGPathAddArc(path, NULL, centerPoint.x, centerPoint.y, rect.size.width / 2.0f - lineWidth / 2.0f, (CGFloat)-M_PI_2, (CGFloat)(-M_PI_2 + 2 * M_PI * _immediateProgress), false);
