...
@property (nonatomic, strong, readonly) NSDictionary *categories;
@property (nonatomic, readonly) bool disabled;

- (instancetype)initWithLastRefreshTimestamp:(NSTimeInterval)lastRefreshTimestamp categories:(NSDictionary *)categories disabled:(bool)disabled;
