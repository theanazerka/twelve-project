...
- (void)checkInputValues {
    ...
    else if (_telegramItem.isChecked)
    {
        ...
        bool hasCorrectSecret = _secretItem.username.length >= 32 && (_secretItem.username.length % 2 == 0) && [_secretItem.username rangeOfCharacterFromSet:invalidChars].location == NSNotFound;
