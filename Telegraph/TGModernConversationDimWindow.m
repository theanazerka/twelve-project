...
{
    UIWindow *rootWindow = (UIWindow *)[[[LegacyComponentsGlobals provider] applicationWindows] firstObject];
    UIViewController *rootController = rootWindow.rootViewController;
