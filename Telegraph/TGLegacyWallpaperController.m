...
@interface TGLegacyWallpaperController () <UIScrollViewDelegate>
{
...
@implementation TGLegacyWallpaperController
...
- (void)loadView
{
    ...
    if (iosMajorVersion() >= 7 && [TGViewController isWidescreen] && [self.presentation.pallete isKindOfClass:[TGDefaultPresentationPallete class]])
    {
    ...
    {
        _panelView.backgroundColor = self.presentation.pallete.barBackgroundColor;
    }
    ...
    _cancelButton.highlightedBackgroundColor = self.presentation.pallete.selectionColor;
    ...
    [_cancelButton setTitleColor:self.presentation.pallete.textColor forState:UIControlStateNormal];
    ...
    _setButton.highlightedBackgroundColor = self.presentation.pallete.selectionColor;
    ...
    [_setButton setTitleColor:self.presentation.pallete.textColor forState:UIControlStateNormal];
    ...
    _separatorView.backgroundColor = self.presentation.pallete.barSeparatorColor;
    ...
    _bottomView.backgroundColor = self.presentation.pallete.barSeparatorColor;
