...
int32_t TGModernLegacyIdForModernId(int64_t modernUserId)
{
    ...
    TGLog(@"IOS6AUTH mapped modern user id %lld -> legacy %d", modernUserId, legacyId);
    return legacyId;
}
...
- (id<TLObject>)TLdeserialize:(NSInputStream *)is signature:(int32_t)signature environment:(id<TLSerializationEnvironment>)environment context:(TLSerializationContext *)__unused context error:(__autoreleasing NSError **)error
{
    ...
    int32_t flags2 = 0;
    bool hasModernFlags2 = signature == (int32_t)0x31774388 || signature == (int32_t)0x83314fca || signature == (int32_t)0x215c4438 || signature == (int32_t)0x2813e6db || signature == (int32_t)0x1afeb7ac || signature == (int32_t)0xd0a1d008;
    bool isModernLongUser = signature == (int32_t)0x31774388 || signature == (int32_t)0x83314fca || signature == (int32_t)0x215c4438 || signature == (int32_t)0x2813e6db || signature == (int32_t)0x1afeb7ac || signature == (int32_t)0xd0a1d008;
    if (hasModernFlags2)
        flags2 = [is readInt32];
    ...
    if (hasModernFlags2 && (flags2 & (1 << 15)))
        [is readInt64];
    if (hasModernFlags2 && (flags2 & (1 << 20)))
        [is readInt64];
