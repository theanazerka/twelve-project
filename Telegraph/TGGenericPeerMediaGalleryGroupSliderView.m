...
#import "../submodules/LegacyComponents/LegacyComponents/TGImageMediaAttachment.h"
#import "../submodules/LegacyComponents/LegacyComponents/TGVideoMediaAttachment.h"
...
- (void)layoutSubviews
{
    ...
    CGSize imageSize = ((TGGenericPeerGalleryGroupItem *)_items[_currentItemIndex]).imageSize;
    ...
    for (TGImageView *view in _scrollView.subviews)
    {
        ...
        if (!_panning && progress > FLT_EPSILON)
        {
            ...
            {
                CGSize nextSize = [self constrainedSize:((TGGenericPeerGalleryGroupItem *)_items[_currentItemIndex + 1]).imageSize];
            ...
            {
                CGSize previousSize = [self constrainedSize:((TGGenericPeerGalleryGroupItem *)_items[_currentItemIndex - 1]).imageSize];
