                        ...
                        if (actionInfo != nil && actionInfo.actionType == TGMessageActionChatEditPhoto) {
                            ...
                            if (imageMedia != nil) {
                                ...
                                if (TGStringCompare(imageLegacyThumbnailUrl, legacyThumbnailUrl)) {
                                    ...
                                    TGGroupAvatarGalleryItem *photoItem = [[TGGroupAvatarGalleryItem alloc] initWithMessageId:message.mid legacyThumbnailUrl:imageLegacyThumbnailUrl legacyUrl:legacyUrl imageId:imageMedia.imageId imageSize:imageSize originInfo:imageMedia.originInfo];
