...
#import "../submodules/LegacyComponents/LegacyComponents/TGPhotoEditorSliderView.h"
...
- (void)sliderValueChanged:(TGPhotoEditorSliderView *)sender
{
    if (self.valueChanged != nil)
        self.valueChanged([_values[(int)sender.value] intValue]);
    [self updateLabel];
}

- (void)updateLabel
{
    int32_t limit = [_values[(int)_sliderView.value] intValue];
