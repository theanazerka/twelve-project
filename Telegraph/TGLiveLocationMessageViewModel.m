...
#import "../submodules/LegacyComponents/LegacyComponents/TGUser.h"
#import "../submodules/LegacyComponents/LegacyComponents/TGMessage.h"
#import "../submodules/LegacyComponents/LegacyComponents/TGConversation.h"
#import "../submodules/LegacyComponents/LegacyComponents/TGLocationMediaAttachment.h"
...
- (void)bindViewToContainer:(UIView *)container viewStorage:(TGModernViewStorage *)viewStorage
{
    ...
    if (_elapsedModel != nil)
    {
        ...
        [_remainingDisposable setDisposable:[_context.liveLocationRemaining(_message.mid) startWithNext:^(NSNumber *next)
        {
            ...
            if (strongSelf != nil)
                [strongSelf->_elapsedModel setRemaining:[next intValue] period:strongSelf->_period];
